...
## User Interface choices Web vs GUI
...
## Client GUI: Installing Virt-manager in your own Ubuntu desktop


To repeat, Virt-manager should be installed in your own desktop not in Hetzner server.
...
## ISO image installation (Free Dos)


https://www.freedos.org/download/


## QCOW image installation (Rocky Linux example)

https://rockylinux.org/download

## OVA image installation (Jenkins Example)
