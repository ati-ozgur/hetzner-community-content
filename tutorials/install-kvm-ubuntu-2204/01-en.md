...
Our aim is to have virtualization platform managed via web user interface.
...
And, when/if our company needs scale, we should be migrate our virtual machines to physical hardware, starting from database servers.
